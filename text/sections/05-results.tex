...
%In the same vein, when funding increases, count of tenure-track and tenured professors per student increases --- and the opposite in years of funding cuts.
...
%For lecturers, we see a negative effect which lines up with two trends noted in \autoref{sec:trends}: funding for public universities (per student) is decreasing while relative usage of lecturers increased substantially.
