...
States vary largely in how much they fund their public university systems, thanks in part to the state-wide budgeting process.
...
Public universities have relatively lower lobbying power than other funding beneificaries, so often bear the brunt of state government funding cuts \citep{delaney2011state}.\footnote{
...
\autoref{fig:fte-perprof} shows that private universities start with a higher baseline of around 4.5 professors per hundred students, and exhibited yearly variation of less than 0.5 professor per hundred students over the thirty years.
