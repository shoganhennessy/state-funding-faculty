...
The data used in this paper come from two primary sources: \citet[IPEDS]{ipeds} for data on university funding, finances, and enrolment, and \citet[IBHED]{ibhed} for data on every professor in the Illinois public university system.
...
This leads to yearly variation in the amount of funding per student across years, showing that per student state funding varies on multiple dimensions.
