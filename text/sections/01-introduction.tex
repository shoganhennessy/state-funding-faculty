...
It is a priori unclear how faculty may be affected, as there are various margins that universities may respond to funding cuts.
...
In a contemporaneous working paper, \cite{hinrichs2022state} use the same national-level variation in university funding to analyse effects on faculty and wages, coming to different conclusions for the national-level analysis.\footnote{
    An anonymous reviewer made me aware of a similar and contemporary working paper, \cite{hinrichs2022state}.
    My findings are consistent with theirs when restricting to years 2012--2019, but show a substitution towards lecturers when expanding to the entire time period 1990--2021.
    See \autoref{sec:recession-analysis} for this replication.
}
...
In 2021, around 65\% of lecturers at US public universities are employed part-time (IPEDS); this part-time arrangement is often an adjunct contract, where faculty are paid based on how many courses they teach, without employment benefits \citep{aau2014characteristics}.
