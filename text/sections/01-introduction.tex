...
It is possible that universities are be limited from hiring more lecturers by competitive pressures from peer institutions \citep{hoxby2009changing,urquiola2020markets}, leading university administrations to court private funding or raise tuition prices to fill funding gaps, leaving faculty unaffected.

State funding for higher education is not decided randomly, so correlations between state funding and faculty outcomes do not necessarily represent causal relationships.
...
Yearly state government budgets are decided without targetting individual universities for funding cuts, so more reliant universities will be more affected by state-wide changes in higher education funding, allowing the shift-share approach to estimate causal effects among more reliant universities.
...
This approach allows me to test whether the effects of funding cuts are persistent or universities recover quickly e.g., by quickly resuming faculty hiring in years following funding cuts.
...
Universities that rely on more lecturers have persistently lower student retention and graduation rates \citep{jaeger2011examining,ehrenberg2005tenured}
Similarly, students at a large public university have consistently worse education outcomes if taught by adjunct lecturers than those taught by full-time faculty, largely thanks to the worse working conditions adjunct lecturers face \citep{zhu2021limited}.\footnote{
    \cite{bettinger2010does,figlio2015tenure} study lecturers at a highly selective universities, finding that adjunct lecturers improve subject retention for undergraduates compared to professors.
    This paper considers public universities, which are by-majority not selective, and where lecturers are more often employed part-time with less institutional support.
}
