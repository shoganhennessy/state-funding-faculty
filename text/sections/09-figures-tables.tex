...
\begin{table}[H]
    \singlespacing
    \centering
    \caption{First Stage Estimates, Predicting State Funding by Shift-Share shift-share in IPEDS Data.}
...
\begin{table}[H]
    \singlespacing
    \centering
    \caption{Effects of Changes in State Funding on University Faculty Composition, IPEDS 1990--2021, OLS and 2SLS Estimates.}
