...
\begin{figure}[H]
    ...
    \footnotesize
    \textbf{Note}:
    These figures show the local projections estimates of regression specification \eqref{eqn:secondstage}, with the funding shock as an instrument for state funding, using IPEDS data.
...
\begin{table}[H]
    ...
    \makebox[\textwidth][c]{\input{tables/firststage-balance-count.tex}}
    
    \textbf{Panel B: units in log \$ per student}
    
    \makebox[\textwidth][c]{\input{tables/firststage-balance-log.tex}}
...
\begin{table}[H]
    ...
    \makebox[\textwidth][c]{\input{tables/facultycount-shock-reg-rawcount.tex}}
