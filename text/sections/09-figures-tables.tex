...
\begin{figure}[H]
    ...
    \footnotesize
    \textbf{Note}:
    This figure shows the correlation between state funding and the number of total number of professors hired at public universities between 2011--2021, and the line is an OLS line of best-fit.
