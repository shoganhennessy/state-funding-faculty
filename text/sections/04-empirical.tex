...
Additionally, the approach accommodates use of an instrument for state funding \citep{olea2021inference}, so that I use the shift-share instument in local projections estimates as in the rest of the empirical analysis.
