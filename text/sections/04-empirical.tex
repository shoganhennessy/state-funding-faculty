...
This means that state funding would not be conditionally independent of faculty outcomes, and correlations between the two are not causal relationships.
Shifts in state funding for higher education, however, provide an opportunity to address this endogeneity.
