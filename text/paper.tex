...
\date{This version: \today\thanks{
    ...
    \href{https://github.com/shoganhennessy/state-funding-faculty/blob/main/https://github.com/shoganhennessy/state-funding-faculty-2023.pdf}{Newest version available here.}
}
\rhead{\today}
