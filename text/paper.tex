...
%% Title page
% Author
\author{Senan Hogan-Hennessy \\ \vspace{0.1cm}
...
\date{This version: \today\thanks{
    I thank Professor Evan Riehl for guidance on this project, Michael Lovenheim, Ronald Ehrenberg, Douglas Miller, Francine Blau, Levon Barseghyan, and Ryan Dycus for various comments on the project's direction, as well as seminar participants at Cornell University (Autumn 2022) for helpful discussion.
    This project's Github repository, with materials and data (where publicly available) for replication, is available at 
    ...
    \href{https://github.com/shoganhennessy/state-faculty-composition/blob/main/text/paper.pdf}{Newest version available here.}
}
\rhead{\today}
