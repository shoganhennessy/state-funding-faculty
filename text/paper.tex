...
\author{Senan Hogan-Hennessy\thanks{
        ...
        This project's repository, including all materials and anonymised data needed for replication, is made publicly available: 
...
% Title
\title{Less Funding, More Lecturers, and Fewer Professors}
\date{First version: 1 September 2022 \\ \vspace{0.15cm}
    This version:
        \today \\ \vspace{0.25cm}
    \textbf{\textit{Working Paper,
    newest version
    \href{https://raw.githubusercontent.com/shoganhennessy/state-funding-faculty/main/state-funding-faculty-2024.pdf}{available here}.}}
    \vspace{-0.5cm}
}
\rhead{\today}
